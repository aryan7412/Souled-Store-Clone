    ...
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
      <div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-md relative">
        ...
        <div className="flex justify-center mb-4">
          <button className="text-lg font-semibold text-green-700 border-b-2 border-green-700 px-4 py-1 focus:outline-none">
            LOGIN
          </button>
          <button className="text-lg font-semibold text-gray-500 px-4 py-1 focus:outline-none">
            REGISTER
          </button>
        </div>
        <div className="text-center">
          ...
          <div className="relative mb-4">
            ...
            <span className="absolute inset-x-0 top-0 mx-auto w-max -mt-2 bg-white px-2 text-gray-500">
              - OR -
            </span>
          </div>
          <input
          ...
          />
          <button className="w-full py-3 mb-4 bg-red-600 text-white rounded-md hover:bg-red-700 focus:outline-none">
            PROCEED
          </button>
          <div>
            <span className="text-gray-500">New User?</span>
            <a href="#" className="ml-1 text-red-600">
              Create Account
            </a>
          </div>
        </div>
